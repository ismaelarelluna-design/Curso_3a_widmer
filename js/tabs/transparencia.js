...
function exportToPDF() {
    ...
    // Igual que en downloadVoucherPDF: en PWA instalada (standalone) la descarga
    // automática por blob se bloquea. Abrimos la pestaña YA (dentro del clic)
    // y la llenamos con el PDF cuando esté listo. El visor de PDF nativo del
    // navegador ya permite hacer scroll entre todas las páginas del documento.
